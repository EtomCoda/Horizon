              ...
              <div className="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-900/50 rounded-lg p-4">
                <div className="flex items-start gap-3">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-red-600 dark:text-red-400 mt-1">
                            This action is permanent and cannot be undone. All your data, including semesters, courses, and goals, will be permanently erased.
                        </p>
                    </div>
                </div>
                ...
                <div className="mt-6">
                    ...
                    <input
                        ...
                        className="block w-full rounded-md border-red-300 dark:border-red-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-white placeholder-gray-400 focus:border-red-500 focus:ring-red-500 sm:text-sm p-2.5"
                        placeholder="DELETE"
                    />
                </div>
